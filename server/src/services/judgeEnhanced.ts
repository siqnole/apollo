 ...
 */
function extractValue(s: string): NormalizedValue {
 ...
 */
function valuesMatch(actual: NormalizedValue, expected: NormalizedValue): boolean {
 ...
 */
export function judgeFillBlankEnhanced(answer: string, expected: string): JudgeResult {
  try {
...
// Export for testing
export { extractValue, valuesMatch };
